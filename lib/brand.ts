...
export const brand: Brand = {
  name: "Mink'd by Mya",
  shortName: "Mink'd",
  microTag: "LUXURY LASH EXTENSIONS",
  description:
    "Mink'd by Mya in Accra shapes lashes and brows that look like yours, only better — precise, comfortable and made to hold.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0536236333",
    phoneTel: "+233536236333",
    textPhone: "0536236333",
    textPhoneTel: "+233536236333",
    email: "hello@minkd.test",
    privacyEmail: "privacy@minkd.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@minkdbymya", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Mink'd by Mya exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Mink'd by Mya beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Mink'd by Mya self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Mink'd by Mya beauty ritual",
      ...
      },
      {
        ...
        alt: "Mink'd by Mya calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Mink'd by Mya relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Mink'd by Mya beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Mink'd by Mya lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Mink'd by Mya mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Mink'd by Mya makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Mink'd by Mya foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@minkdbymya",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461742/stage4/spa_minkdbymya/tiktok_0.mp4",
        alt: "Mink'd by Mya treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461745/stage4/spa_minkdbymya/tiktok_1.mp4",
        alt: "Mink'd by Mya treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461753/stage4/spa_minkdbymya/tiktok_2.mp4",
        alt: "Mink'd by Mya treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Mink'd by Mya self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Mink'd by Mya studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Mink'd by Mya",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Mink'd by Mya is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0536236333 and text 0536236333 for booking help.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0536236333, text 0536236333, or message @minkdbymya on Instagram." },
          ...
          { q: "Where are you located?", a: "Mink'd by Mya is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Mink'd by Mya (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@minkd.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Mink'd by Mya is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@minkd.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Mink'd by Mya",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0536236333", href: "tel:+233536236333" },
      { label: "Text", value: "0536236333", href: "sms:+233536236333" },
      { label: "Instagram", value: "@minkdbymya", href: "https://www.tiktok.com/@minkdbymya" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783461689/stage4/spa_minkdbymya/avatar.jpg",
    blurb:
      "Mink'd by Mya in Accra — luxury lash extensions.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@minkdbymya" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0536236333", href: "tel:+233536236333" },
          { label: "Text 0536236333", href: "sms:+233536236333" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Mink'd by Mya — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
