...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#672f3d] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#743748]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(67, 27, 38,0.58),rgba(90, 32, 53,0.22)_43%,rgba(69, 30, 40,0.34)),linear-gradient(0deg,rgba(36, 16, 21,0.18),rgba(36, 16, 21,0.08))]" />
